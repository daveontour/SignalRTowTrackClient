...
@Component({
  template: `
    ...
    <div class="modal-body" style="color:black" align="center">
      <p><strong>Active Directory User Validation</strong></p>
      <p>Please enter your <strong>Active Directory</strong> credentials before proceeding</p>
      <table>
...
export class LoginADDialogComponent {
